...
from homeassistant.components.gardena_bluetooth import (
    DeviceUnavailable,
    _async_get_product_type as original_get_product_type,
)
...
async def test_setup_delayed_product(
    ...
    with patch(
        "homeassistant.components.gardena_bluetooth._async_get_product_type",
